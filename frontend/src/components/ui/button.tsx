  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-control text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        mahjong:
          "relative my-[5px] block h-auto w-full cursor-pointer overflow-hidden min-h-12 rounded-control border border-transparent bg-action px-5 py-3 text-base font-semibold text-white shadow-control transition-all duration-300 hover:opacity-90 disabled:cursor-not-allowed disabled:border-white/20 disabled:bg-action-disabled disabled:text-[var(--color-disabled-text)] disabled:opacity-60 disabled:shadow-none disabled:transition-none",
      },
      size: {
        default: "min-h-12 px-5 py-3 has-[>svg]:px-3",
