...
class ContactUpdateSchema(Schema):
    ...
    message = fields.String(required=False, allow_none=True, description="メッセージ内容")
    status = fields.Enum(ContactStatus, by_value=True,required=False, allow_none=True, description="ステータス")
