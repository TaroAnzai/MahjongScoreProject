...
class TestTableEndpoints:
    def test_create_table_requires_tournament_edit(
        self, client, db_session, create_group
    ):
        _group_data, group_links = create_group()
        _tournament_data, tournament_links = _create_tournament(
    ...
    def test_create_table_with_view_link_forbidden(
        self, client, db_session, create_group
    ):
        _group_data, group_links = create_group()
        _tournament_data, tournament_links = _create_tournament(
    ...
    def test_get_table_requires_view(self, client, db_session, create_group):
        ...
        forbidden = client.get(
            f"/api/tables/{tournament_links[AccessLevel.VIEW.value]}"
        )
    ...
    def test_delete_table_requires_tournament_edit(
        self, client, db_session, create_group
    ):
        _group_data, group_links = create_group()
        _tournament_data, tournament_links = _create_tournament(
    ...
    def test_get_games_by_table(
        ...
        # --- GET: 一覧取得 ---
        res_list = client.get(
            f"/api/tables/{table_links[AccessLevel.VIEW.value]}/games"
        )
